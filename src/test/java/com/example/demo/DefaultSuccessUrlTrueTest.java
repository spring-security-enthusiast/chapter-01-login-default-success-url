...
@Import({
        DefaultSuccessUrlTrueTest.TestSecurityConfig.class,
        UserConfig.class
})
public class DefaultSuccessUrlTrueTest {

    @Autowired
    MockMvc mvc;

    @Test
    @DisplayName("Should always redirect to /home after login even if original request was /about")
    void defaultSuccessUrlTrueTest() throws Exception {
